                ...
                <form class="flex items-center w-full md:w-3/4 max-w-lg 2xl: mx-auto bg-white rounded-full px-5 py-2.5">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" id="voice-search"
                            class=" text-gray-900 text-sm md:text-normal lg:text-lg rounded-lg  block w-full ps-10 p-2.5    border-none focus:ring-0 focus:border-none placeholder:text-lg rtl"
